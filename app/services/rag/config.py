...
RAG_GENERATION_EVAL_REPORT_PATH = RAG_REPORTS_DIR / "generation_eval_report.json"
RAG_GENERATION_EVAL_CSV_PATH = RAG_REPORTS_DIR / "generation_eval_report.csv"
RAG_GENERATION_JUDGE_REPORT_PATH = RAG_REPORTS_DIR / "generation_judge_report.json"
RAG_GENERATION_JUDGE_CSV_PATH = RAG_REPORTS_DIR / "generation_judge_report.csv"
...
RAG_RUNTIME_DIR = ARTIFACTS_DIR / "rag"
RAG_CHUNK_EMBEDDINGS_PATH = RAG_RUNTIME_DIR / "intfloat_e5_small_v2_chunks.npy"
RAG_CHUNK_EMBEDDINGS_MANIFEST_PATH = (
    RAG_RUNTIME_DIR / "intfloat_e5_small_v2_manifest.json"
)
